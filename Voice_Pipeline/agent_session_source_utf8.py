class AgentSession(rtc.EventEmitter[EventTypes], Generic[Userdata_T]):
    ...
    async def start(
        ...
        *,
        ...
        async with self._lock:
            ...
            # on_enter produces next ù and never completes when on_enter says nothing.
    ...
    async def wait_for_idle(self) -> AgentActivity:
        ...
        while True:
            ...
            try:
                ...
                # handoff in flight ù re-target to whatever's current now
    ...
    def _emit_debug_message(self, payload: dict[str, Any]) -> None:
        """:meta private: internal ù emit a debug/trace payload to the debugger/recorder."""
        st = Struct()
